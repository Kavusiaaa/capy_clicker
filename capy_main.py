...
bg_img = pygame.image.load('capyclicker/bg.png')
bg_img = pygame.transform.scale(bg_img, (WIDTH, HEIGHT))
clock = pygame.time.Clock()

######################################################
player_image_original = pygame.image.load('capyclicker/capy.png')
...
text_3 = font.render(f'Upgrade: {upgrade_cost}', True, (0, 0, 0))
...
text_5 = font.render(f'CPS: {cps}', True, (0, 0, 0))
...
while running:
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == pygame.K_s:
                if coins >= upgrade_2_cost:
                    ...
                    text_4 = font.render(f'CPS: {cps}', True, (0, 0, 0))
                    text_4_rect = text_4.get_rect()
                    text_4_rect.center = (750, 150)
                    text_5 = font.render(f'Upgrade CPS: {upgrade_2_cost}', True, (0, 0, 0))
                    text_5_rect = text_5.get_rect()
                    text_5_rect.center = (750, 225)
                else:
                    print("No money")
    text_1 = font.render(f'Coins: {coins}', True, (0, 0, 0))
    text_1_rect = text_1.get_rect()
    ...
    text_2_rect = text_2.get_rect()
    text_2_rect.center = (200, 75)
    text_3 = font.render(f'Upg. CPC: {upgrade_cost}', True, (0, 0, 0))
    text_3_rect = text_3.get_rect()
    text_3_rect.center = (200, 225)  
    text_4 = font.render(f'CPS: {cps}', True, (0, 0, 0))
    text_4_rect = text_4.get_rect()
    text_4_rect.center = (750, 150)
    text_5 = font.render(f'Upg. CPS: {upgrade_2_cost}', True, (0, 0, 0))
    text_5_rect = text_5.get_rect()
    text_5_rect.center = (750, 225)         
